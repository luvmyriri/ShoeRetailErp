    ...
    <div class="container">
        ...
        <div class="filters-section">
            <div class="filters-header">
                <div class="filters-title">≡ƒöì Filter Customers</div>
        ...
        <div class="content-card">
            <div class="card-header">
                ...
                <div class="card-actions">
                    ...
                    <button class="icon-btn" title="Sort">Γçà</button>
                    <button class="icon-btn" title="Settings">ΓÜÖ∩╕Å</button>
                </div>
            </div>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        foreach ($customers as $customer) {
                            ...
                            echo '<div>≡ƒôº ' . $customer['email'] . '</div>';
                            echo '<div>≡ƒô▒ ' . $customer['phone'] . '</div>';
                            echo '</div>';
                            echo '</td>';
                            ...
                            echo '<td><span class="' . $statusClass . '">ΓùÅ ' . $customer['status'] . '</span></td>';
                            echo '<td>';
            ...
            <div class="table-footer">
                ...
                <div class="pagination">
                    <?php if ($page > 1): ?>
                        <a href="?<?php echo http_build_query(array_merge($_GET, ['page' => $page - 1])) ?>" class="btn">ΓÇ╣</a>
                    <?php endif; ?>
    ...
    <div class="modal-overlay" id="addCustomerModal">
        <div class="modal">
            <div class="modal-header">
                ...
                <button class="close-btn" onclick="closeModal('addCustomerModal')">Γ£ò</button>
            </div>
    ...
    <div class="modal-overlay" id="viewCustomerModal">
        <div class="modal">
            <div class="modal-header">
                ...
                <button class="close-btn" onclick="closeModal('viewCustomerModal')">Γ£ò</button>
            </div>
            <div class="modal-body">
    ...
    <div class="modal-overlay" id="editCustomerModal">
        <div class="modal">
            <div class="modal-header">
                ...
                <button class="close-btn" onclick="closeModal('editCustomerModal')">Γ£ò</button>
            </div>
            <div class="modal-body">
    ...
    <div class="modal-overlay" id="deleteModal">
        <div class="modal">
            <div class="modal-header">
                ...
                <button class="close-btn" onclick="closeModal('deleteModal')">Γ£ò</button>
            </div>
            <div class="modal-body">
