...
<body>
    ...
    <div class="container">
        ...
        <div class="stats-grid">
            ...
            $statCards = [
                ['icon' => '≡ƒæÑ', 'label' => 'Total Customers', 'sublabel' => 'Active in CRM', 'data' => $total, 'color' => '#dbeafe'],
                ['icon' => 'Γ£à', 'label' => 'Qualified Customers', 'sublabel' => 'Ready for deals', 'data' => $qualified, 'color' => '#d1fae5'],
                ['icon' => '≡ƒÆ░', 'label' => 'Pipeline Value', 'sublabel' => 'Potential revenue', 'data' => $value, 'color' => '#fef3c7']
            ];
            ...
            foreach ($statCards as $s) {
                ...
                echo '<div class="stat-trend ' . $dir . '"><span>' . ($dir === 'up' ? 'Γåæ' : 'Γåô') . '</span><span>' . $s['data']['trend'] . '</span></div>';
                echo '</div>';
                ...
                <th>Actions</th>
                    ...
                    <div class="action-buttons">
                        ...
                        <button class="delete-btn" onclick="deleteCustomer(' . $row['CustomerID'] . ')">Delete</button>
                                    ...
                                    echo '<td>Γé▒' . number_format($row['TotalValue'], 2) . '</td>';
    ...
    <div class="modal-overlay" id="addLeadModal">
        <div class="modal">
            <div class="modal-header">
                ...
                <button class="close-btn" onclick="closeModal('addLeadModal')">Γ£ò</button>
            </div>
            <div class="modal-body">
                <form id="leadForm" method="POST">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            <label for="potential_value">Potential Value (Γé▒)</label>
    ...
    <div class="modal-overlay" id="dealModal">
        <div class="modal">
            <div class="modal-header">
                ...
                <button class="close-btn" onclick="closeModal('dealModal')">Γ£ò</button>
            </div>
            <div class="modal-body">
                <form id="dealForm" method="POST">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            <label for="edit_deal_value">Deal Value (Γé▒)</label>
    ...
    <div class="modal-overlay" id="taskModal">
        <div class="modal">
            <div class="modal-header">
                ...
                <button class="close-btn" onclick="closeModal('taskModal')">Γ£ò</button>
            </div>
            <div class="modal-body">
    ...
    <div class="modal-overlay" id="assignTaskModal">
        <div class="modal">
            <div class="modal-header">
                ...
                <button class="close-btn" onclick="closeModal('assignTaskModal')">Γ£ò</button>
            </div>
            <div class="modal-body">
    ...
    <div class="modal-overlay" id="addTaskModal">
        <div class="modal">
            <div class="modal-header">
                ...
                <button class="close-btn" onclick="closeModal('addTaskModal')">Γ£ò</button>
            </div>
            <div class="modal-body">
    ...
    <div class="modal-overlay" id="viewModal">
        <div class="modal">
            <div class="modal-header">
                ...
                <button class="close-btn" onclick="closeModal('viewModal')">Γ£ò</button>
            </div>
            <div class="modal-body">
                ...
                details.innerHTML = `
                    <div class="lead-details">
                        ...
                        <div class="detail-row">
                            ...
                            <div class="detail-value">Γé▒${parseFloat(leadData.PotentialValue).toFixed(2)}</div>
                        </div>
                        <div class="detail-row">
